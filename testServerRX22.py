...
class Team():
    ...
    def HRB(self, message, file):
        stream = open('/home/icleanyooven/catkin_ws/src/topcat_system/judges_station/nodes/hbmessage.yaml', 'r')
        ...
        data['name'] = message[6]
        data['mode'] = message[7]
        with open ('/home/icleanyooven/catkin_ws/src/topcat_system/judges_station/nodes/hbmessage.yaml', 'w') as file:
            file.write(yaml.dump(data, default_flow_style=False))

        with open (r'/home/icleanyooven/catkin_ws/src/topcat_system/judges_station/nodes/hbmessage.yaml') as file:
            HB = yaml.load(file, Loader=yaml.FullLoader)
            print(HB)
        # with open('message.yaml', 'w') as yaml_file:
...
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.wfile.write(bytes("<p>Request: %s</p>" % currentMessage, "utf-8"))
